...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // drawer.setDrawerListener(toggle);  // obsoleto
        drawer.addDrawerListener(toggle); // metodo actualizado
        toggle.syncState();
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_lista) {
            ...
            Toast.makeText(contexto, "En el futuro podrá enviar su lista de la compra aquí", Toast.LENGTH_SHORT).show();
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
        return true;
    ...
    protected void sendEmail() {  // método para enviar email
        String[] TO = {"agoney.informatica@gmail.com"}; // coreo de destino
        String[] CC = {""};  // copia para
        Intent emailIntent = new Intent(Intent.ACTION_SEND);
        emailIntent.setData(Uri.parse("mailto:")); // acción de enviar el email
        // Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto","agoney.informatica@gmail.com", null));
        emailIntent.setType("text/plain"); // formato del texto
